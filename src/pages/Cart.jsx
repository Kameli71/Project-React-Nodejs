    ...
    <Container>
        ...
        <Wrapper>
            ...
            <Bottom>
                <Info>
                    <Product>
                        <ProductDetail>
                            ...
                            <Details>
                            <ProductName>
                                <b>Produit:</b> Chaussures JESSIE THUNDER 
                            </ProductName>
                            <ProductId>
                                <b>ID:</b> 93813718293
                            </ProductId>
                ...
                <Summary>
                    <SummaryTitle>Résumé de votre commande</SummaryTitle>
                    <SummaryItem>
                        <SummaryItemText>Total partiel</SummaryItemText>
                        <SummaryItemPrice>95€</SummaryItemPrice>
                    </SummaryItem>
                    <SummaryItem>
                        <SummaryItemText>Estimation de l'envoi</SummaryItemText>
                        <SummaryItemPrice>8.90€</SummaryItemPrice>
                    </SummaryItem>
                    <SummaryItem>
                        <SummaryItemText>Remise sur les frais d'envoi</SummaryItemText>
                        <SummaryItemPrice>-8.90€</SummaryItemPrice>
                    </SummaryItem>
